The idea of this project is to make a simple yet robust data morpher. This will be used for 
later projects, so I figured I would post it here. 
...
This is the concept of the morph, you give it an initial data, and it will use that data to 
create something... morphed :)
